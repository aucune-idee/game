...
let LobbiesController = class LobbiesController {
    ...
    getOwnLobbies(request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.findLobbies.getLobbies({ member: request.locals.jwt.payload.id });
        });
    }
    getLobby(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    joinLobby(lobbyId, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.lobbyMembership.join({
                userId: request.locals.jwt.payload.id,
                lobbyId: lobbyId
            });
        });
    }
    leaveLobby(lobbyId, request) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    selectArmy(lobbyId, request, body) {
        return __awaiter(this, void 0, void 0, function* () {
